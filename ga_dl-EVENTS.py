...
sample_request = {
      ...
      'dimensions': [{'name': 'ga:campaign'}, {'name': 'ga:devicecategory'}, {'name': 'ga:city'}, {'name': 'ga:country'}, {'name': 'ga:userType'}, {'name': 'ga:sourceMedium'}, {'name': 'ga:eventCategory'}, {'name': 'ga:eventAction'}, {'name': 'ga:eventLabel'}],
      'metrics': [{'expression': 'ga:Users'}, {'expression': 'ga:pageviews'}, {'expression': 'ga:sessions'}, {'expression': 'ga:sessionDuration'},  {'expression': 'ga:totalEvents'},  {'expression': 'ga:uniqueEvents'}, {'expression': 'ga:sessionsWithEvent'}],
      "pageSize" : 100000
    }
